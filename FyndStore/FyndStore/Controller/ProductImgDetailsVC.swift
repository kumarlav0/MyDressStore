...
class ProductImgDetailsVC: UIViewController {
    ...
    @IBAction func backAction(_ sender: Any) {
           // self.hideShowImg(isHidden: true)
    ...
    func setData()
    {
        ...
        let url = URL(string: productData!.productImg)
...
extension ProductImgDetailsVC: UIScrollViewDelegate{
